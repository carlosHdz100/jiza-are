      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Rentas finalizadas</p>
        ...
        <div class="card-header pb-0">
          <div class="row">
            <div class="col-lg-6 col-7">
              <h6>Rentas del mes</h6>
              <p class="text-sm mb-0">
                <i class="fa fa-check text-info" aria-hidden="true"></i>
                <!-- <span class="font-weight-bold ms-1">Este</span> mes -->
            ...
            <div class="col-lg-6 col-5 my-auto text-end">
              <div class="dropdown float-lg-end pe-4">
                ...
                <!-- <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5" aria-labelledby="dropdownTable">
                  <li><a class="dropdown-item border-radius-md" href="javascript:;">Ir a rentas</a></li>
                </ul> -->
              </div>
            </div>
          </div>
      ...
      <div class="card h-100">
        <div class="card-header pb-0">
          ...
          <p class="text-sm">
            ...
            <span class="font-weight-bold">últimos</span> ingresos
          </p>
        </div>
        <div class="card-body p-3">
          <div class="timeline timeline-one-side">
            <div class="timeline-block mb-3">
              <span class="timeline-step">
                <i class="ni ni-world text-success text-gradient"></i>
              </span>
              <div class="timeline-content">
                <h6 class="text-dark text-sm font-weight-bold mb-0">Admin</h6>
                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">22 JUN</p>
              </div>
            </div>
            <div class="timeline-block mb-3">
              <span class="timeline-step">
                <i class="ni ni-world text-danger text-gradient"></i>
              </span>
              <div class="timeline-content">
                <h6 class="text-dark text-sm font-weight-bold mb-0">Tienda A</h6>
                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">21 JUN</p>
              </div>
            </div>
            ...
            <div class="timeline-block">
              ...
              <div class="timeline-content">
                <h6 class="text-dark text-sm font-weight-bold mb-0">Tienda B</h6>
                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">17 JUN</p>
              </div>
            </div>
          </div>
        </div>
