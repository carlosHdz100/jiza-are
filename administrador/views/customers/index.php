                ...
                <div class="row container">
                    ...
                    <div class="col-lg-6 d-flex justify-content-end">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end col-lg-6">
                            <button onclick="view('')" class="btn btn-info me-md-2" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Agregar cliente</button>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0" id="tabla">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">cliente@cliente.com</p>
                                    </td>
...
<script src="assets/js/src/customers.js"></script>