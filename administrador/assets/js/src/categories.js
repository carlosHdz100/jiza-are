...
function createTable(status) {
    const url = `db_functions/categories.php?action=all&status=${status}`;
        ...
        fetch(url, {
            ...
            .then((data) => {
                ...
                if (data.status) {
                    const attr = {
                        modal: {
                            title: 'Modificar datos de la categoría',
...
function create() {
    ...
    if (form) {
        const url = `db_functions/categories.php?action=create`;
...
function update(id) {
    ...
    if (form) {
        const url = `db_functions/categories.php?action=update`;
...
function desactivate(id) {
    const url = `db_functions/categories.php?action=desactivate`;
    let datos = new FormData();
    // Agregar el ID al FormData
