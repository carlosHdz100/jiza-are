<div class="page-content mt-2">
    ...
    <div class="card card-style">
        <div class="content">
            <h1 class="text-center font-700 mb-1">Vestidos</h1>
        </div>
    </div>
...
<div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel" style="height: auto;">
    ...
    <div class="offcanvas-body small">
        ...
        <div class="d-flex justify-content-between">
            ...
            <button class="custom-btn btn-5" id="sa" data-menu="menu-event-calendar"><span>Opciones de Fecha</span></button>
...
<div id="menu-event-calendar" class="menu menu-box-bottom menu-box-detached" data-menu-height="370" style="display: block; height: 370px; z-index:99999">
    <div class="calendar bg-theme m-0" style="max-width:100%!important;">
        ...
        <button class="addMonthsBtn" id="addMonthsBtn" onclick="addMonths()">Mes siguiente
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-arrow-right-filled" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <!-- Botón para regresar a los meses -->
        <button class="subtractMonthsBtn" id="subtractMonthsBtn" onclick="subtractMonths()">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-arrow-left-filled" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
