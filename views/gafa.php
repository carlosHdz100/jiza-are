    ...
    <div class="card card-style mx-0 pb-5 pt-1">
        ...
        <div class="row mb-0">
            ...
            <div class="card card-style mx-0 col-12 col-md-6 col-lg-4">
                <div class="card card-style mx-2 mt-2" data-card-height="400" style="background-image:url('https://img.freepik.com/foto-gratis/vista-frontal-gafas-sol-arena-playa_23-2148557643.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=ais')">
            ...
            <div class="card card-style mx-0 col-12 col-md-6 col-lg-4">
                <div class="card card-style mx-2 mt-2" data-card-height="400" style="background-image:url('https://img.freepik.com/fotos-premium/gafas-sol-estrellas-mar-beige_185193-35855.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=ais')">
                    <div class="card-top p-3 pe-2 pt-2">
                ...
                <div class="content mt-n3">
                    <div class="d-flex">
                        <div class="me-auto align-self-center">
                            <h2 class="mb-n1">Gafas de Sol 2</h2>
                            <span class="d-block color-green-dark font-700">Veces rentado: +10</span>
                        </div>
                        <div class="ms-auto align-self-center">
                            <h1 class="pt-2">$32.<sup class="font-14 font-400 opacity-50">99</sup></h1>
                    ...
                    <p class="font-12 line-height-m pt-2 mb-2">
                        Con esta gafa de podrás tener una comodidad increíble, además de poder usarlo para cualquier ocasión. Estamos seguros que te encantará.
                    </p>
                    <div class="d-flex">
                        <div class="align-self-center">
                            <span>
                ...
                <div class="splide__list">
                    <div class="splide__slide">
                        <a href="#" class="mx-3" data-menu="menu-reserve" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">
                            <div class="card card-style me-0 mb-0" style="background-image:url(https://img.freepik.com/fotos-premium/gafas-sol-rojas-arena_954950-15.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=ais);" data-card-height="250">
                                <div class="card-top p-2">
                                    <span class="bg-red-dark color-white px-2 py-1 rounded-xs font-11 font-700">-10%</span>
                                </div>
                                <div class="card-bottom p-2 px-2">
                                    <h4 class="color-white line-height-s">Gafas de Sol</h4>
                    ...
                    <div class="splide__slide">
                        <a href="#" class="mx-3" data-menu="menu-reserve" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">
                            <div class="card card-style me-0 mb-0" style="background-image:url(https://img.freepik.com/foto-gratis/par-gafas-sol-negras-modernas-vista-superior-sobre-fondo-amarillo-negro-aislado-vision-gafas-elegancia_140725-16987.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=ais);" data-card-height="250">
                                <div class="card-top p-2">
    ...
    <div class="offcanvas-body small">
        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                ...
                <img src="https://img.freepik.com/foto-gratis/gafas-sol-colores-primer-plano-sombra_23-2148290419.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=ais" class="d-block w-100 rounded" alt="...">
                </div>
        ...
        <p class="mb-2">Este gafa de sol está disponible para alquiler. Es la elección perfecta para ocasiones especiales, como bodas, fiestas de gala y eventos elegantes. Destaca tu estilo con esta gafa de sol exclusiva.</p>
