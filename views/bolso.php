    ...
    <div class="card card-style mx-0 pb-5 pt-1">
        ...
        <div class="row mb-0">
            ...
            <div class="card card-style mx-0 col-12 col-md-6 col-lg-4">
                <div class="card card-style mx-2 mt-2" data-card-height="400" style="background-image:url('https://img.freepik.com/foto-gratis/bastante-magnifica-joven-morena-timida-posando-calle-paris-mirada-dama-elegante-verano-colores-beige-experiencia-viaje_291049-1756.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=sph')">
            ...
            <div class="card card-style mx-0 col-12 col-md-6 col-lg-4">
                <div class="card card-style mx-2 mt-2" data-card-height="400" style="background-image:url('https://img.freepik.com/fotos-premium/cerca-mujer-sosteniendo-bolso-cuero-rojo_220873-558.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=sph')">
                    <div class="card-top p-3 pe-2 pt-2">
                ...
                <div class="splide__list">
                    <div class="splide__slide">
                        <a href="#" class="mx-3" data-menu="menu-reserve" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">
                            <div class="card card-style me-0 mb-0" style="background-image:url(https://img.freepik.com/foto-gratis/hermosa-mujer-piernas-delgadas-tacones-amarillos-chica-moda-tiene-elegante-bolso-azul-concepto-glamour-elegante-arte-mujer-camina-despues-ir-compras-mujer-irreconocible_186202-4466.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=sph);" data-card-height="250">
                                <div class="card-top p-2">
                                    <span class="bg-red-dark color-white px-2 py-1 rounded-xs font-11 font-700">-10%</span>
                                </div>
                                <div class="card-bottom p-2 px-2">
                                    <h4 class="color-white line-height-s">Bolso</h4>
                    ...
                    <div class="splide__slide">
                        <a href="#" class="mx-3" data-menu="menu-reserve" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">
                            <div class="card card-style me-0 mb-0" style="background-image:url(https://img.freepik.com/foto-gratis/mujer-bolso-mano-blanco_53876-108628.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=sph);" data-card-height="250">
                                <div class="card-top p-2">
    ...
    <div class="offcanvas-body small">
        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                ...
                <img src="https://img.freepik.com/foto-gratis/_23-2150709609.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=ais" class="d-block w-100 rounded" alt="...">
                </div>
        ...
        <p class="mb-2">Este bolso está disponible para alquiler. Es la elección perfecta para ocasiones especiales, como bodas, fiestas de gala y eventos elegantes. Destaca tu estilo con este bolso exclusiva.</p>
