<div class="page-content mt-2">
    ...
    <div class="card card-style">
        <div class="content">
            <h1 class="text-center font-700 mb-1">Bolsos</h1>
        </div>
    </div>
    ...
    <div class="row mb-0">
        ...
        <div class="card card-style mx-0 col-12 col-md-6 col-lg-4">
            <div class="card card-style mx-2 mt-2" data-card-height="400">
                ...
                <div class="card-image">
                    <img src="https://img.freepik.com/fotos-premium/cerca-mujer-sosteniendo-bolso-cuero-rojo_220873-558.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=sph" alt="">
                </div>
            </div>
            <div class="content mt-n3">
                <div class="d-flex">
