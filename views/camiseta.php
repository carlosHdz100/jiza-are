    ...
    <div class="card card-style mx-0 pb-5 pt-1">
        ...
        <div class="row mb-0">
            ...
            <div class="card card-style mx-0 col-12 col-md-6 col-lg-4">
                <div class="card card-style mx-2 mt-2" data-card-height="400" style="background-image:url('https://img.freepik.com/foto-gratis/sesion-fotos-al-aire-libre-primer-plano-blanco-camisa-casual-negocios_53876-119744.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=sph')">
            ...
            <div class="card card-style mx-0 col-12 col-md-6 col-lg-4">
            <div class="card card-style mx-2 mt-2" data-card-height="400" style="background-image:url('https://img.freepik.com/foto-gratis/modelo-camiseta-negra-aislada-vista-frontal_125540-1073.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=sph')">
                <div class="card-top p-3 pe-2 pt-2">
                    <a href="#" data-toast="snackbar-favorites" class="float-end">
                        <span class="bg-theme color-theme px-2 py-2 rounded-sm">
                            <i class="fa fa-heart color-red-dark pe-1"></i>
    ...
    <div class="offcanvas-body small">
        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                ...
                <img src="https://img.freepik.com/foto-gratis/camisa-blanca-palabra-t-ella_1340-25481.jpg?size=626&ext=jpg&ga=GA1.1.649413161.1697839706&semt=sph" class="d-block w-100" alt="...">
                </div>
