    ...
    <div class="card card-style">
        <div class="content text-center">
            ...
            <div class="tab-controls tabs-small rounded mt-2" data-highlight="bg-blue-dark">
                <a href="#" data-active="" data-bs-toggle="collapse" data-bs-target="#tab-1" class="bg-blue-dark no-click" aria-expanded="true">Por entregar</a>
                <a href="#" data-bs-toggle="collapse" data-bs-target="#tab-2" class="collapsed" aria-expanded="false">En proceso</a>
                <a href="#" data-bs-toggle="collapse" data-bs-target="#tab-3" class="collapsed" aria-expanded="false">Finalizadas</a>
                <a href="#" data-bs-toggle="collapse" data-bs-target="#tab-4" class="collapsed" aria-expanded="false">Canceladas</a>
            </div>
        </div>
    </div>
