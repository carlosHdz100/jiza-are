<div class="page-content mt-4" style="transform: translateX(0px);">
    ...
    <div class="content mt-0">
        <div class="d-flex">
            <div class="align-self-center">
                ...
                <h1 class="font-30"><?= $usuario->usu_nombre ?></h1>
            </div>
    ...
    <div data-card-height="130" class="card card-style rounded-m shadow-xl preload-img entered loaded" data-src="images/pictures/11w.jpg" data-ll-status="loaded" style="height: 240px; background-image: url(&quot;images/pictures/11w.jpg&quot;);">
        ...
        <div class="card-center text-center">
            <h1 class="color-white fa-4x"><span id="monto"></span> €</h1>
            <p class="color-white opacity-70 font-11 mb-n5">Ingresos</p>
        </div>
    ...
    <div class="card card-style">
        <div class="content text-center">
            ...
            <div class="tab-controls tabs-medium tabs-rounded" data-highlight="bg-highlight">
                <a href="#" onclick="listarRentas(0)" class="font-600 bg-highlight no-click" data-active="" data-bs-toggle="collapse" data-bs-target="#tab-1" aria-expanded="true">Por entregar</a>
                <a href="#" onclick="listarRentas(3)" class="font-600 collapsed" data-bs-toggle="collapse" data-bs-target="#tab-2" aria-expanded="false">En renta</a>
            </div>
        </div>
    </div>
    <div class="card card-style" style="max-height: 350px; overflow: auto;">
...
<div id="menu-transaction-1" class="menu menu-box-bottom menu-box-detached" style="display: block; height: 580px; overflow:auto">
    ...
    <div class="content">
        ...
        <div class="row mb-0">
            ...
            <div class="col-12">
                <a id="usu_telefono" href="https://wa.me/9933770652" target="__blank" class="default-link btn btn-l rounded-sm btn-full bg-green-white text-uppercase font-800 btn-icon mb-3"><i class="fa"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-whatsapp" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
