    ...
    fetch(url)
        ...
        .then(data => {
            ...
            datos.forEach(item => {
                ...
                <div class="d-flex align-items-center ms-auto">
                <button type="button" onclick="addGarmentWhislist(${item.gar_id})" class="icon icon-s bg-theme rounded-l shadow-xl rounded-m ms-2 color-theme"><i class="fa fa-heart ${isWishList == true ? 'color-red-dark' : ''} font-14"></i></button>
